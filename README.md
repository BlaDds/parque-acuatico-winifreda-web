...
Además de resubir el código desde 0 a GitHub por errores humanos como filtrar una contraseña...
...
Backend: Se implementó un script en PHP que actúa como webhook para sincronizar datos desde Google Sheets hacia un archivo .json.

Seguridad: El script de procesamiento y las credenciales de acceso se han omitido del repositorio para mantener la sencillez del código y proteger los tokens de autenticación y la integridad del servidor.
...
- Escribí 'dev' en la consola de desarrollo, sin las comillas.
